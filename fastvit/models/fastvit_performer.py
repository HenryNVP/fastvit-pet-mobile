...
from fastvit.models.modules.mobileone import MobileOneBlock
from fastvit.models.modules.replknet import ReparamLargeKernelConv
...
class MHSA(nn.Module):
    """Multi-headed Self Attention module using Performer (lucidrains).

    Works on 3D (B, N, C) or 4D (B, C, H, W) input tensors.
    ...
    def __init__(
        ...
        Args:
            ...
            qkv_bias: Use bias or not for QKV. Default: ``False``.
            attn_drop: Dropout rate inside Performer attention.
            proj_drop: Dropout rate for final projection tensor.
        """
        super().__init__()
        ...
        self.attn = PerformerSelfAttention(
            ...
            dim_head=head_dim,
            causal=False,        # set True if you ever need causal attention
            dropout=attn_drop,
            qkv_bias=qkv_bias,
        )
...
class FastViT_Performer(nn.Module):
    """
...
@register_model
def fastvit_t8_P(pretrained=False, **kwargs):
    """Instantiate FastViT_Performer-T8 model variant."""
    layers = [2, 2, 4, 2]
...
def fastvit_ma36(pretrained=False, **kwargs):
    ...
    if pretrained:
        raise ValueError("Functionality not implemented.")
    return model
>>>>>>> 35a8a0cc776b9b81cddb4c5480d8eb13479148fb
